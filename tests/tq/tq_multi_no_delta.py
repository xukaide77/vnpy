...
logger = setup_logger(file_name=os.path.join(os.path.dirname(__file__), 'in_day_trade_no_delta'),
                           name='trade_pp',
                           log_level=logging.DEBUG,
                           backtesing=True)
price_logger = setup_logger(file_name=os.path.join(os.path.dirname(__file__), 'in_day_price_no_delta'),
                      name='price_pp',
                      log_level=logging.DEBUG,
                      backtesing=True)

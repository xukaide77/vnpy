...
logger = setup_logger(file_name=os.path.join(os.path.dirname(__file__), 'order_flow_trade150'),
                           name='trade150',
...
api = TqApi(TqSim(20000), backtest=TqBacktest(start_dt=date(2020, 5, 18), end_dt=date(2020, 8, 3)), web_gui=True, auth="xukaide77,xk82513994")

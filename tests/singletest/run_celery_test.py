...
test_setting['start_date'] = '20200707'
test_setting['init_days'] = 5
test_setting['end_date'] = '20210130'
...
symbol_datas = get_symbol_configs(
    ...
    bar_file_format='h:' + '/bar_data/tdx/{}99_20160101_1m.csv'
)
...
while True:
    for task_id in task_ids:
        result = execute.AsyncResult(task_id)
        print(result.status)
    sleep(5)
